...
> **Reddit requires a `User-Agent` header** identifying the application and developer. The hardcoded value in `reddit.py` is `web:syncup:0.1.0 (by /u/halva2251)`. Update it if project ownership changes.
